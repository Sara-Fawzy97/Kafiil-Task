...
//display sidebar section in mobile view

let sideGrid = document.getElementById('sideGrid');

function openBar() {
    if (sideGrid.style.diaplay = "none")
        sideGrid.style.display = "block"
    else {
        sideGrid.style.display = 'none';
